...
public class ReportServiceImpl implements ReportService {
    ...
    public void exportBusinessData(HttpServletResponse response) {
        ...
        BusinessDataVO businessDataVO = workSpaceService.getBusinessData(dateBegin.atStartOfDay(), dateEnd.atTime(LocalTime.MAX));
        ...
        try(XSSFWorkbook excel = new XSSFWorkbook(in);
            ...
            for(int i = 0; i < 30; i++){
                ...
                BusinessDataVO businessData = workSpaceService.getBusinessData(date.atStartOfDay(), date.atTime(LocalTime.MAX));
